  ...
  return (
    <div>
      <div className="page-header flex-between">
        <div><h1>Patients</h1><p>View and create patient records</p></div>
      ...
      <div className="card">
        <div className="table-wrapper">
          {loading ? (
            ...
            <table>
              <thead>
                <tr><th>ID</th><th>Name</th><th>DOB</th><th>Gender</th><th>Guardian ID</th><th>Created</th></tr>
              </thead>
              <tbody>
                {filtered.map(p => (
                  <tr key={p.patientId}>
      ...
      {showModal && (
        ...
        >
          ...
          <div className="form-group"><label>Guardian ID (optional)</label><input type="number" value={form.guardianId} onChange={set('guardianId')} /></div>
